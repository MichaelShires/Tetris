...
/**
 * LLeft.java:
 * Creates an L-shaped tetronimo with a leftward orientation (the opposite of a traditional L) in
...
public class LLeft extends Tetronimo
{
  ...
  public LLeft()
  {
    ...
    super.r1.setFillColor(Color.MAGENTA);
    super.r2.setFillColor(Color.MAGENTA);
    super.r3.setFillColor(Color.MAGENTA);
    super.r4.setFillColor(Color.MAGENTA);
  ...
  public void rotateShape()
  {
    ...
    int rotatePosition = super.curRotation % 4;
  ...
  {
    rectangles[(this.r1.getXLocation() - 40)/ Tetronimo.SIZE][this.r1.getYLocation() / Tetronimo.SIZE].setFillColor(Color.MAGENTA);
    rectangles[(this.r2.getXLocation() - 40)/ Tetronimo.SIZE][this.r2.getYLocation() / Tetronimo.SIZE].setFillColor(Color.MAGENTA);
    rectangles[(this.r3.getXLocation() - 40)/ Tetronimo.SIZE][this.r3.getYLocation() / Tetronimo.SIZE].setFillColor(Color.MAGENTA);
    rectangles[(this.r4.getXLocation() - 40)/ Tetronimo.SIZE][this.r4.getYLocation() / Tetronimo.SIZE].setFillColor(Color.MAGENTA);
