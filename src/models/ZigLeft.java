...
/**
 * ZigLeft.java:
 * Creates a ZigLeft tetronimo. A ZigLeft shape is a vertical zig-zag with the zag to the right,
 * giving the shape a leftward orientation.
 *
 ...
 * @see java.awt.Point
 */
public class ZigLeft extends Tetronimo
{
  /**
  ...
  public ZigLeft()
  {
    ...
    super.r1.setFillColor(Color.CYAN);
    super.r2.setFillColor(Color.CYAN);
    super.r3.setFillColor(Color.CYAN);
    super.r4.setFillColor(Color.CYAN);
  ...
  {
    rectangles[(this.r1.getXLocation() - 40)/ Tetronimo.SIZE][this.r1.getYLocation() / Tetronimo.SIZE].setFillColor(Color.CYAN);
    rectangles[(this.r2.getXLocation() - 40)/ Tetronimo.SIZE][this.r2.getYLocation() / Tetronimo.SIZE].setFillColor(Color.CYAN);
    rectangles[(this.r3.getXLocation() - 40)/ Tetronimo.SIZE][this.r3.getYLocation() / Tetronimo.SIZE].setFillColor(Color.CYAN);
    rectangles[(this.r4.getXLocation() - 40)/ Tetronimo.SIZE][this.r4.getYLocation() / Tetronimo.SIZE].setFillColor(Color.CYAN);
