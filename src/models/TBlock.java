...
/**
 * TBlock.java:
 * Creates a T-block tetronimo with a vertical orientation.
 *
...
public TBlock()
{
  ...
  super.r1.setFillColor(Color.YELLOW);
  super.r2.setFillColor(Color.YELLOW);
  super.r3.setFillColor(Color.YELLOW);
  super.r4.setFillColor(Color.YELLOW);
  ...
  {
    rectangles[(this.r1.getXLocation() - 40)/ Tetronimo.SIZE][this.r1.getYLocation() / Tetronimo.SIZE].setFillColor(Color.YELLOW);
    rectangles[(this.r2.getXLocation() - 40)/ Tetronimo.SIZE][this.r2.getYLocation() / Tetronimo.SIZE].setFillColor(Color.YELLOW);
    rectangles[(this.r3.getXLocation() - 40)/ Tetronimo.SIZE][this.r3.getYLocation() / Tetronimo.SIZE].setFillColor(Color.YELLOW);
    rectangles[(this.r4.getXLocation() - 40)/ Tetronimo.SIZE][this.r4.getYLocation() / Tetronimo.SIZE].setFillColor(Color.YELLOW);
