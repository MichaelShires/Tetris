...
/**
 * LRight.java:
 * Creates an L-shaped tetronimo with a rightward orientation (a traditional L) in
...
public class LRight extends Tetronimo
{
  ...
  public LRight()
  {
    ...
    super.r1.setFillColor(Color.PINK);
    super.r2.setFillColor(Color.PINK);
    super.r3.setFillColor(Color.PINK);
    super.r4.setFillColor(Color.PINK);
  ...
  {
    rectangles[(this.r1.getXLocation() - 40)/ Tetronimo.SIZE][this.r1.getYLocation() / Tetronimo.SIZE].setFillColor(Color.PINK);
    rectangles[(this.r2.getXLocation() - 40)/ Tetronimo.SIZE][this.r2.getYLocation() / Tetronimo.SIZE].setFillColor(Color.PINK);
    rectangles[(this.r3.getXLocation() - 40)/ Tetronimo.SIZE][this.r3.getYLocation() / Tetronimo.SIZE].setFillColor(Color.PINK);
    rectangles[(this.r4.getXLocation() - 40)/ Tetronimo.SIZE][this.r4.getYLocation() / Tetronimo.SIZE].setFillColor(Color.PINK);
